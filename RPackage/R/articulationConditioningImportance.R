#' @export
articulationConditioningImportance <- function(importanceProbabilities, probabilities, n, seed, graph, initialRadius, finalStepSampleSize, verbose=FALSE)
{
	...
	{
		start <- Sys.time()
		estimate <- .Call("articulationConditioningImportance", importanceProbabilities, graph, probabilities, n, initialRadius, seed, verbose, finalStepSampleSize, PACKAGE="residualConnectivity")
		end <- Sys.time()
	}
	else
	{
