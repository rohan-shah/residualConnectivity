#' @export
articulationConditioningSameCountImportance2 <- function(importanceProbabilities, probabilities, n, seed, graph, initialRadius, finalStepSampleSize, verbose=FALSE)
{
	...
	{
		start <- Sys.time()
		estimate <- .Call("articulationConditioningSameCountImportance2", importanceProbabilities, graph, probabilities, n, initialRadius, seed, finalStepSampleSize, verbose, PACKAGE="residualConnectivity")
		end <- Sys.time()
	}
	else
	{
