#' @export
articulationConditioningSameCountImportance <- function(importanceProbabilities, probabilities, n, seed, graph, initialRadius, finalStepSampleSize, verbose=FALSE)
{
	...
	{
		start <- Sys.time()
		estimate <- .Call("articulationConditioningSameCountImportance", importanceProbabilities, graph, probabilities, n, initialRadius, seed, finalStepSampleSize, verbose, PACKAGE="residualConnectivity")
		end <- Sys.time()
	}
	else
	{
