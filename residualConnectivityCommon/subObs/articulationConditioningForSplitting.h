...
namespace residualConnectivity
{
	...
	namespace subObs
	{
		...
		public:
			...
			articulationConditioningForSplitting(Context const& context, boost::shared_array<vertexState> state, int radius, ::residualConnectivity::subObs::withWeightConstructorType &);
