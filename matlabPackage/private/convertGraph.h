...
bool convertGraphNoPositions(const mxArray *inputGraph, const mxArray *inputPositions, discreteGermGrain::Context::inputGraph& outputGraph, std::vector<discreteGermGrain::Context::vertexPosition>& positions, std::string& error);
#endif
